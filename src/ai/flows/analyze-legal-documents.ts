...
4. {{#if regulations}}A compliance analysis for the following regulations: {{{regulations}}}. For each regulation, state whether the document appears compliant and provide your reasoning.{{/if}}
